...
import { Gavel, Scale, FileCheck, ArrowRight, CheckCircle2, ShieldCheck } from "lucide-react";
             ...
             <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div className="lg:col-span-8 space-y-12">
                   <div className="bg-white p-12 rounded-[3rem] shadow-2xl shadow-black/[0.03] border border-gray-100">
                      ...
                      <div className="mt-16 p-10 bg-[var(--deep-section)] text-white rounded-[2rem] relative overflow-hidden group border-2 border-[var(--primary)]">
                         <div className="absolute inset-0 bg-[var(--primary)] opacity-0 group-hover:opacity-10 transition-opacity"></div>
                         <div className="relative z-10 flex items-start gap-6">
                            <Gavel size={32} className="text-[var(--accent)] shrink-0 mt-1" />
                            <div>
                               <p className="text-xl font-black uppercase italic tracking-tight mb-2">{t('ethics')}</p>
