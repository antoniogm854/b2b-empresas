...
import { TrendingUp, PieChart, ArrowRight, CheckCircle2, BarChart3 } from "lucide-react";
import Link from "next/link";
import { getTranslations } from "next-intl/server";

export async function generateMetadata() {
  const t = await getTranslations("Inversores");
  return {
    title: t('seo_title'),
                   ...
                   <div className="bg-white p-12 rounded-[3rem] shadow-2xl shadow-black/[0.03] border border-gray-100">
                      ...
                      <div className="mt-16 p-10 bg-[var(--deep-section)] text-white rounded-[2rem] relative overflow-hidden group">
                         ...
                         <div className="relative z-10 flex items-start gap-6">
                            <PieChart size={32} className="text-[var(--accent)] shrink-0 mt-1" />
                            <div>
