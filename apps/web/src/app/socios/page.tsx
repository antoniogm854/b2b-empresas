...
import { Users2, Layers, ArrowRight, CheckCircle2 } from "lucide-react";
  ...
  return (
    <PublicLayout>
       ...
       <div className="bg-[var(--deep-section)] text-white py-32 md:py-48 relative overflow-hidden">
          <div className="absolute inset-0 bg-[url('/hero.webp')] opacity-10 mix-blend-overlay bg-cover bg-center scale-105 animate-subtle-zoom"></div>
             ...
             <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                   ...
                   <div className="bg-white p-12 rounded-[3rem] shadow-2xl shadow-black/[0.03] border border-gray-100">
                      ...
                      <div className="mt-16 p-10 bg-[var(--deep-section)] text-white rounded-[2rem] relative overflow-hidden group">
                         ...
                         <div className="relative z-10 flex items-start gap-6">
                            <Layers size={32} className="text-[var(--accent)] shrink-0 mt-1" />
                            <div>
                               <p className="text-xl font-black uppercase italic tracking-tight mb-2">{t('cta_badge')}</p>
                ...
                <div className="lg:col-span-4 space-y-8">
                   ...
                   <div className="bg-gray-100 p-10 rounded-[3rem] border border-gray-200">
                      ...
                      <Link href="/quality" className="block font-bold text-[var(--strong-text)] hover:text-[var(--primary)] transition-colors mb-2">{tFooter('quality')} &rarr;</Link>
                      <Link href="/security" className="block font-bold text-[var(--strong-text)] hover:text-[var(--primary)] transition-colors">{tFooter('security')} &rarr;</Link>
                   </div>
                </div>
