      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex justify-between items-end">
          <div className="space-y-2">
            <h1 className="text-4xl font-black text-slate-900 tracking-tight">Consola del Comprador</h1>
            <p className="text-slate-500 font-medium">Gestione sus solicitudes masivas y compare ofertas de proveedores.</p>
          </div>
          ...
          <div className="flex gap-4">
             <div className="bg-white p-4 rounded-3xl shadow-sm border border-slate-200 flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-400 uppercase">Solicitudes Activas</p>
             ...
             <div className="bg-white p-4 rounded-3xl shadow-sm border border-slate-200 flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-400 uppercase">Ofertas Recibidas</p>
